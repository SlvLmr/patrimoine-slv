...
const navItems = [
  ...
  { id: 'revenus-depenses', label: 'Revenus & Dépenses', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
...
function initNav() {
  ...
  nav.innerHTML = navItems.map(item => `
    <a href="#${item.id}" data-nav="${item.id}"
      class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm hover:bg-indigo-50 hover:text-indigo-700 transition-colors text-gray-600">
