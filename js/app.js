import { Store } from './store.js?v=20260809a';
...
import * as RevenusDepenses from './components/revenus-depenses.js?v=20260809a';
import * as Projection from './components/projection.js?v=20260809a';
import * as SuiviDepenses from './components/suivi-depenses.js?v=20260809a';
import * as PortefeuilleLive from './components/portefeuille-live.js?v=20260809a';
import * as Contrats from './components/contrats.js?v=20260809b';
import * as Liberte from './components/liberte.js?v=20260809a';
import * as Conseiller from './components/conseiller.js?v=20260809b';
import * as Compte from './components/compte.js?v=20260809a';
import * as Repartition from './components/repartition.js?v=20260809a';
import * as SimulateurFire from './components/simulateur-fire.js?v=20260809a';
import * as SimulateurCredit from './components/simulateur-credit.js?v=20260809a';
import * as SimulateurInterets from './components/simulateur-interets.js?v=20260809a';
import * as SimulateurAuto from './components/simulateur-auto.js?v=20260809a';
import * as SimulateurSalaire from './components/simulateur-salaire.js?v=20260809a';
import * as Hypotheses from './components/hypotheses.js?v=20260809a';
import * as SimulateurSuccession from './components/simulateur-succession.js?v=20260809a';
import { saveToDrive, loadFromDrive, listDriveFiles, isGdriveConfigured, setClientId } from './gdrive.js?v=20260809a';
import { showToast, promptModal, confirmModal } from './utils.js?v=20260809a';
...
const navItems = [
  ...
  { id: 'conseiller', label: 'Conseiller Horizon', icon: 'M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z' },
