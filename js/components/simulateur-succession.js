import { formatCurrency, parseNumberInput } from '../utils.js?v=11';
  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div class="lg:col-span-5 space-y-4">
        ...
        <div class="card-dark rounded-2xl p-3 sm:p-5 space-y-3">
          <h3 class="text-sm font-semibold text-gray-300 uppercase tracking-wider flex items-center gap-2">
      ...
      <div class="lg:col-span-7 space-y-4">
        ...
        <!-- Reserve héréditaire -->
        <div class="card-dark rounded-2xl p-3 sm:p-5" id="succ-reserve-card">
