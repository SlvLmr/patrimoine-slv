import { formatCurrency, formatCurrencyCents, formatPercent, parseNumberInput, promptModal } from '../utils.js?v=20260809a';
...
function renderResults(r, inputs) {
  ...
  container.innerHTML = `
    <!-- Mensualité -->
    <div class="card-dark rounded-xl p-3 sm:p-4 col-span-2 sm:col-span-3 bg-gradient-to-r from-blue-500/5 to-cyan-500/5 border border-blue-500/10">
    ...
    <!-- Taux d'endettement -->
    <div class="card-dark rounded-xl p-4 ${endettementBg}">
