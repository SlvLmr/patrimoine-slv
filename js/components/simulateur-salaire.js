import { formatCurrency, parseNumberInput } from '../utils.js?v=20260807d';
...
export function render() {
  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <!-- Col 1: Saisie brut -->
      <div class="card-dark rounded-xl p-3 sm:p-5 space-y-5">
    ...
    <!-- Net après impôts -->
    <div class="card-dark rounded-xl border-accent-green/20 p-3 sm:p-5">
