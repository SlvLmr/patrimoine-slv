import { formatCurrency, formatDate, openModal, inputField, selectField, getFormData } from '../utils.js?v=6';
          ...
          <div class="p-4 hover:bg-dark-600/30 transition flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex gap-1">
                ...
                <button data-delete-heritage="${item.id}" class="btn-delete" title="Supprimer">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
