import { formatCurrency, formatPercent, computeProjection, inputField, selectField, getFormData, getPlacementGroupKey, openModal, confirmModal, showToast } from '../utils.js?v=20260807g';
...
import * as ProjectionEnfants from './projection-enfants.js?v=20260807g';
...
import { getEnfants, childAge, CHILD_COLORS } from './projection-enfants.js?v=20260807g';
...
export function mount(store, navigate) {
  ...
  document.getElementById('btn-export-pdf')?.addEventListener('click', async (e) => {
    ...
    try {
      const { exportProjectionPDF } = await import('../export-pdf.js?v=20260807g');
