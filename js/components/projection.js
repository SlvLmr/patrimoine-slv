import { formatCurrency, formatPercent, computeProjection, inputField, selectField, getFormData, getPlacementGroupKey, openModal, confirmModal, showToast } from '../utils.js?v=20260807e';
import { createChart, COLORS, createVerticalGradient, VIVID_PALETTE, ASSET_COLORS } from '../charts/chart-config.js';
import { openAddPlacementModal, openEditPlacementModal } from './placement-form.js?v=20260807e';
import * as ProjectionEnfants from './projection-enfants.js?v=20260807e';
...
import { getEnfants, childAge, CHILD_COLORS } from './projection-enfants.js?v=20260807e';
...
export function mount(store, navigate) {
  ...
  document.getElementById('btn-export-pdf')?.addEventListener('click', async (e) => {
    ...
    try {
      const { exportProjectionPDF } = await import('../export-pdf.js?v=20260807e');
