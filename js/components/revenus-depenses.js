import { formatCurrencyCents, openModal, getFormData, inputField, selectField, confirmModal } from '../utils.js?v=20260808a';
  ...
  return `
    <div class="space-y-6">
      <div>
        ...
        <p class="text-gray-500 text-sm mt-1">Tes revenus et dépenses récurrents du mois</p>
      </div>
