import { formatCurrency, formatPercent, parseNumberInput, promptModal } from '../utils.js?v=20260807g';
...
function renderResults(r) {
  ...
  container.innerHTML = `
    <!-- FIRE Number -->
    <div class="card-dark rounded-xl p-3 sm:p-4 col-span-2 sm:col-span-3 bg-gradient-to-r from-orange-500/5 to-amber-500/5 border border-orange-500/10">
    ...
    <!-- Revenus passifs détaillés -->
    <div class="card-dark rounded-xl p-3 sm:p-4 col-span-2 sm:col-span-3 border border-amber-500/10">
...
function metricCard(label, value, colorClass, sub) {
  return `
    <div class="card-dark rounded-xl p-3 sm:p-4">
