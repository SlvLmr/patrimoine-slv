    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="card-dark rounded-xl p-5 kpi-card glow-green">
          ...
          <p class="text-2xl font-bold text-accent-green">${formatCurrency(immoTotal)}</p>
        </div>
        <div class="card-dark rounded-xl p-5 kpi-card glow-blue">
          ...
          <p class="text-2xl font-bold text-accent-blue">${formatCurrency(placTotal)}</p>
        </div>
        ...
        <div class="card-dark rounded-xl p-5 kpi-card glow-green">
          ...
          <p class="text-2xl font-bold ${capacite >= 0 ? 'text-accent-green' : 'text-accent-red'}">${formatCurrency(capacite)}<span class="text-sm font-normal text-gray-500">/mois</span></p>
        </div>
      </div>
